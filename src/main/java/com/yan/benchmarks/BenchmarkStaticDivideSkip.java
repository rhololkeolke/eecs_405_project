...
import com.devinschwab.eecs405.mergeskip.DivideSkip;
 ...
 */
public class BenchmarkStaticDivideSkip {
    ...
    public static void main(String rawArgs[]) {
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(args.benchmarkFile))) {
            ...
            for (File indexFile : staticIndexFiles) {
                ...
                DivideSkip divideSkip = new DivideSkip(invertedLists);
                ...
                for (int k = args.kmin; k < args.kmax; k++) {
                    ...
                    try (BufferedReader queryReader = new BufferedReader(
                        ...
                        for (CSVRecord record : queryParser) {
                            ...
                            stopwatch.start();
                            List<Integer> candidates = divideSkip.mergeLists(queryString, q, k, .0085);
                            stopwatch.stop();
